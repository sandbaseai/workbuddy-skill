...
| [Architecture Friction Scan](skills/architecture-friction-scan/) | Scan hot spots for shallow modules, leaking seams, test friction, and evidence-backed deepening candidates | [MIT source](skills/architecture-friction-scan/SOURCE.json) |
| [Agent Document Design](skills/agent-document-design/) | Design precise Agent-facing documents with reliable triggers, disclosure hierarchy, completion gates, pruning, and evaluations | [MIT source](skills/agent-document-design/SOURCE.json) |
| [Evidence Before Claims](skills/evidence-before-claims/) | Verify completion, tests, releases, remote state, and requirements with fresh evidence matched to each claim | [MIT source](skills/evidence-before-claims/SOURCE.json) |
| [Parallel Agent Dispatch](skills/parallel-agent-dispatch/) | Partition independent work, isolate Agent context, dispatch concurrently, review conflicts, and verify integrated results | [MIT source](skills/parallel-agent-dispatch/SOURCE.json) |
| [Plan Execution](skills/plan-execution/) | Execute written plans in ordered checkpoints with focused/full verification, authority boundaries, recovery, and durable handoff | [MIT source](skills/plan-execution/SOURCE.json) |
...
| [Agent Decision Receipts](skills/decision-receipts/) | Bind consequential Agent actions to signed, secret-safe manifests with offline verification, policy scope, key boundaries, and explicit unsigned states | [MIT source](skills/decision-receipts/SOURCE.json) |
...
| [Codebase Onboarding](skills/codebase-onboarding/) | Map repository facts, setup, architecture, ownership, troubleshooting, baseline evidence, and documentation drift for new contributors | [MIT source](skills/codebase-onboarding/SOURCE.json) |
| [Network Troubleshooting](skills/network-troubleshooting/) | Isolate DNS, routing, transport, TLS, HTTP, policy, resource, and MTU failures with bounded evidence and verified remediation | [MIT source](skills/network-troubleshooting/SOURCE.json) |
| [Chaos Engineer](skills/chaos-engineer/) | Design authorized resilience experiments with measurable hypotheses, bounded blast radius, tested rollback, and learning follow-ups | [MIT source](skills/chaos-engineer/SOURCE.json) |
...
|---|---:|
| Indexed GitHub paths | 12,644 |
| Unique content SHAs | 8,017 |
...
The current static analysis successfully inspected 12,644 paths: 9,956 are structurally adaptable to WorkBuddy, 910 need manual review, 0 are currently WorkBuddy-ready, and 418 contain at least one conservative security signal.
