...
|---|---:|
| Indexed GitHub paths | 11,957 |
| Unique content SHAs | 7,584 |
| Source repositories | 6,128 |
<!-- CATALOG-METRICS:END -->
...
The current static analysis successfully inspected 11,957 paths: 9,882 are structurally adaptable to WorkBuddy, 907 need manual review, 0 are currently WorkBuddy-ready, and 409 contain at least one conservative security signal.
