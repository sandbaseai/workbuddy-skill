...
|---|---:|
| Indexed GitHub paths | 12,387 |
| Unique content SHAs | 7,812 |
| Source repositories | 6,327 |
<!-- CATALOG-METRICS:END -->
...
The current static analysis successfully inspected 12,387 paths: 9,877 are structurally adaptable to WorkBuddy, 905 need manual review, 0 are currently WorkBuddy-ready, and 414 contain at least one conservative security signal.
