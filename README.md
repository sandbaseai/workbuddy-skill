...
|---|---:|
| Indexed GitHub paths | 12,507 |
| Unique content SHAs | 7,914 |
| Source repositories | 6,385 |
<!-- CATALOG-METRICS:END -->
...
The current static analysis successfully inspected 12,507 paths: 9,927 are structurally adaptable to WorkBuddy, 901 need manual review, 0 are currently WorkBuddy-ready, and 413 contain at least one conservative security signal.
