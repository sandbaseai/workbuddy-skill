...
|---|---:|
| Indexed GitHub paths | 11,857 |
| Unique content SHAs | 7,523 |
| Source repositories | 6,090 |
<!-- CATALOG-METRICS:END -->
...
The current static analysis successfully inspected 11,857 paths: 9,912 are structurally adaptable to WorkBuddy, 903 need manual review, 0 are currently WorkBuddy-ready, and 416 contain at least one conservative security signal.
