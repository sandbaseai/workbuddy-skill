...
|---|---:|
| Indexed GitHub paths | 12,157 |
| Unique content SHAs | 7,695 |
| Source repositories | 6,224 |
<!-- CATALOG-METRICS:END -->
...
The current static analysis successfully inspected 12,157 paths: 9,874 are structurally adaptable to WorkBuddy, 903 need manual review, 0 are currently WorkBuddy-ready, and 412 contain at least one conservative security signal.
