...
|---|---:|
| Indexed GitHub paths | 12,057 |
| Unique content SHAs | 7,641 |
| Source repositories | 6,175 |
<!-- CATALOG-METRICS:END -->
...
The current static analysis successfully inspected 12,057 paths: 9,876 are structurally adaptable to WorkBuddy, 907 need manual review, 0 are currently WorkBuddy-ready, and 411 contain at least one conservative security signal.
