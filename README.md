...
|---|---:|
| Indexed GitHub paths | 10,901 |
| Unique content SHAs | 6,959 |
| Source repositories | 5,631 |
<!-- CATALOG-METRICS:END -->
...
The current static analysis successfully inspected 10,901 paths: 9,868 are structurally adaptable to WorkBuddy, 905 need manual review, 1 are currently WorkBuddy-ready, and 402 contain at least one conservative security signal.
