...
|---|---:|
| Indexed GitHub paths | 10,300 |
| Unique content SHAs | 6,634 |
| Source repositories | 5,221 |
<!-- CATALOG-METRICS:END -->
...
The current static analysis successfully inspected 10,300 paths: 9,156 are structurally adaptable to WorkBuddy, 884 need manual review, 0 are currently WorkBuddy-ready, and 257 contain at least one conservative security signal.
