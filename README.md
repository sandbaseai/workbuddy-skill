...
|---|---:|
| Indexed GitHub paths | 11,202 |
| Unique content SHAs | 7,130 |
| Source repositories | 5,815 |
<!-- CATALOG-METRICS:END -->
...
The current static analysis successfully inspected 11,202 paths: 10,270 are structurally adaptable to WorkBuddy, 932 need manual review, 0 are currently WorkBuddy-ready, and 541 contain at least one conservative security signal.
