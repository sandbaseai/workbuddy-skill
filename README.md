...
|---|---:|
| Indexed GitHub paths | 11,538 |
| Unique content SHAs | 7,303 |
| Source repositories | 5,956 |
<!-- CATALOG-METRICS:END -->
...
The current static analysis successfully inspected 11,538 paths: 9,850 are structurally adaptable to WorkBuddy, 901 need manual review, 0 are currently WorkBuddy-ready, and 405 contain at least one conservative security signal.
