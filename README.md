...
|---|---:|
| Indexed GitHub paths | 10,900 |
| Unique content SHAs | 6,958 |
| Source repositories | 5,630 |
<!-- CATALOG-METRICS:END -->
...
The current static analysis successfully inspected 10,900 paths: 9,867 are structurally adaptable to WorkBuddy, 905 need manual review, 1 are currently WorkBuddy-ready, and 402 contain at least one conservative security signal.
