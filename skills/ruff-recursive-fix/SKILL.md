...
display_name: "Ruff 递归修复"
display_name_en: "Ruff Recursive Fix"
...
description_zh: "按范围运行 Ruff，分阶段应用修复并逐次复核差异。"
description_en: "Run Ruff in bounded passes, apply fixes carefully, and review each diff before continuing."
