...
display_name: "AI 团队协作"
display_name_en: "AI Team Orchestration"
...
description_zh: "用轻量级角色分工协调规划、实现、测试与合并。"
description_en: "Coordinate planning, implementation, testing, and merging with a lightweight agent team."
