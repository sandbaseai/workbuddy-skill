...
display_name: "Agent Skill 组合器"
display_name_en: "Agent Skill Stack"
...
description_zh: "根据用户目标寻找、评估并组合最小可用的 Skill 集合。"
description_en: "Find, evaluate, and assemble the smallest compatible set of Skills for a user outcome."
