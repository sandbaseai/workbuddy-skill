...
display_name: "Spring Boot 测试"
display_name_en: "Spring Boot Testing"
...
description_zh: "根据场景选择 Spring Boot 测试切片、断言、Mock 和 Testcontainers 策略。"
description_en: "Choose Spring Boot test slices, assertions, mocks, and Testcontainers patterns for the scenario."
