...
for package in packages:
    package_items_by_category.setdefault(package["category"], []).append(
        ...
        f"<p><a href=\"{escape(package['source_url'], quote=True)}\" aria-label=\"Inspect pinned source for {escape(package['name'], quote=True)}\">Inspect pinned source</a> · "
...
<html lang="en">
  ...
  <body>
    <header>
      ...
      <p>Need platform or data-boundary guidance? See the <a href="https://github.com/sandbaseai/workbuddy-skill/blob/main/docs/resources.md">resource map</a>, <a href="https://github.com/sandbaseai/workbuddy-skill/blob/main/docs/resources.zh-CN.md">资源地图</a>, and the <a href="https://www.workbuddy.ai/document/privacy-policy">official Privacy Policy</a> before using sensitive inputs or connectors。</p>
