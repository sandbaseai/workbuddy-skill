...
its [Schema](https://sandbaseai.github.io/workbuddy-skill/packages-schema.json). Each package record includes a `checksum_url` for verifying the downloaded ZIP.
