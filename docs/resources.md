...
- [E-commerce visual copywriting Skill](https://github.com/feichanggege/ecommerce-visual-copywriting-skill) — a WorkBuddy-compatible e-commerce visual-copy workflow with a large community footprint; the repository currently declares no license, so use it only as a research reference until rights and bundled assets are clarified.
- [agency-agents-zh](https://github.com/jnMetaCode/agency-agents-zh) — Chinese collection of reusable expert roles across engineering, design, marketing, finance, and other workflows; no repository license is currently declared, so treat it as research-only until rights are clarified.
