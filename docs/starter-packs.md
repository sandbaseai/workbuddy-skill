...
| Build an evidence map | [evidence-map-builder](https://github.com/sandbaseai/workbuddy-skill/releases/latest/download/evidence-map-builder-workbuddy-skill.zip) | Claims, sources, confidence, and unresolved questions |
